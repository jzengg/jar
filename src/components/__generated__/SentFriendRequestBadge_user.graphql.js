...
declare export opaque type SentFriendRequestBadge_user$ref: FragmentReference;
export type SentFriendRequestBadge_user = {|
  +sentFriendRequests: ?{|
    +edges: ?$ReadOnlyArray<?{|
      +node: {|
        +id: string,
    ...
    |}>
  |},
  +$refType: SentFriendRequestBadge_user$ref,
|};
*/
  ...
  "selections": [
    {
      ...
      "name": "__SentFriendRequestBadge_sentFriendRequests_connection",
      "storageKey": null,
      "args": null,
...
// prettier-ignore
(node/*: any*/).hash = 'c5b008b5ece410a335f912b0e91f05f8';
module.exports = node;
